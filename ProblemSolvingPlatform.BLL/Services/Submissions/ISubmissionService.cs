...
{ 
    ...
    public Task<DetailedSubmissionDTO?> GetDetailedSubmissionByID(int submissionId, int requestedBy);
    public Task<SubmissionDTO?> GetSubmissionByID(int submissionId, int requestedBy);
